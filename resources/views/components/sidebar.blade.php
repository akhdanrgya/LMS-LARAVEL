<div class="fixed top-0 left-0 h-screen w-[198px] bg-white flex flex-col gap-7 px-6 py-2.5 overflow-y-auto z-50">
  ...
  <a href="{{ route('dashboard') }}" class="flex items-center gap-2.5 cursor-pointer px-2 py-1 rounded hover:bg-[#f3f4f6]">
    <i class="fas fa-home text-[#4c5a73] w-4"></i>
    <p class="text-sm text-[#4c5a73]">Home</p>
  </a>

  <a href="{{ route('dashboard.courses') }}" class="flex items-center gap-2.5 cursor-pointer px-2 py-1 rounded hover:bg-[#f3f4f6]">
    <i class="fas fa-chalkboard-user text-[#4c5a73] w-4"></i>
    <p class="text-sm text-[#4c5a73]">Courses</p>
  </a>

  <a href="{{ route('dashboard.task') }}" class="flex items-center gap-2.5 cursor-pointer px-2 py-1 rounded hover:bg-[#f3f4f6]">
    <i class="fas fa-list-check text-[#4c5a73] w-4"></i>
    <p class="text-sm text-[#4c5a73]">Task</p>
  </a>

  <a href="{{ route('dashboard.forum') }}" class="flex items-center gap-2.5 cursor-pointer px-2 py-1 rounded hover:bg-[#f3f4f6]">
